...
"""
edx_courses_api documentation build configuration file.
...
project = 'edx_courses_api'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'edx_courses_api'
...
#
# html_title = 'edx_courses_api v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_courses_api'),
                os.path.join(root_path, 'edx_courses_api/migrations')])
